from cocoa_folder.cocoa.core.scenario_db import Scenario as BaseScenario
from cocoa_folder.cocoa.core.schema import Attribute
from cocoa_folder.craigslistbargain.core.kb import KB
